...
export const customPropertyOperations: INodeProperties[] = [
		...
		options: [
			{
				name: 'Binaries',
				value: 'AcBinaries',
				description: 'Extend binary schema',
				action: 'Update an custom property',
			},
			{
				name: 'Computers',
				value: 'Computers',
				description: 'Extend computer schema',
				action: 'Create a custom property',
			},
			{
				name: 'Devices',
				value: 'Devices',
				description: 'Extend device schema',
				action: 'Get many custom properties',
			},
			{
				name: 'Drive',
				value: 'Drives',
				description: 'Extend drive schema',
				action: 'Get an custom property',
			},
			{
				name: 'Software',
				value: 'Softwares',
				description: 'Extend software schema',
				action: 'Update an custom property',
			},
			{
				name: 'User',
	...
	},
	{
		...
		options: [
			{
				name: 'Check Extension Properties',
				value: 'check',
				description: 'Check Custom Property in the Scheme and create or update it',
				action: 'Check extension properties and create or update it',
			},
			{
				...
				validation: [
					{
						...
						properties: {
							regex: '[0-9]+',
							errorMessage: 'Not a valid Schema Extension ID',
						},
					},
				],
			},
